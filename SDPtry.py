...
def send_email_to_customer(customer_email):
    ...
    email_server.login('your_email_address@gmail.com', 'your_email_password')

    # Set up the email message
    email_subject = 'Seat Booking Notification'
    email_body = 'Dear Customer,\n\nWe are sorry to inform you that the seat you wanted to book is currently unavailable. We will notify you as soon as it becomes available.\n\nBest regards,\nThe Restaurant Team'
    email_message = f'Subject: {email_subject}\n\n{email_body}'

    # Send the email
    email_server.sendmail('your_email_address@gmail.com', customer_email, email_message)
    email_server.quit()
...
def seatchooser():
    ...
    label2_1 = Label(root4, text="2A", background="green" if "2A" not in seat_choices.values() else "red", fg='white', font=('Calibri', 20, 'bold'))
    ...
    label2_2 = Label(root4, text="2B", background="green" if "2B" not in seat_choices.values() else "red", fg='white', font=('Calibri', 20, 'bold'))
    label2_2.place(x=275, y=314, width=154)

    seat_3 = Label(root4, image=img_2_tk)
    seat_3.place(x=475, y=160)

    label2_3 = Label(root4, text="2C", background="green" if "2C" not in seat_choices.values() else "red", fg='white', font=('Calibri', 20, 'bold'))
    label2_3.place(x=475, y=314, width=154)

    seat4 = Label(root4, image=img_2_tk)
    seat4.place(x=675, y=160)

    label2_4 = Label(root4, text="2D", background="green" if "2D" not in seat_choices.values() else "red", fg='white', font=('Calibri', 20, 'bold'))
    ...
    label4_1 = Label(root4, text="4A", background="green" if "4A" not in seat_choices.values() else "red", fg='white', font=('Calibri', 20, 'bold'))
    label4_1.place(x=75, y=544, width=154)

    seat2 = Label(root4, image=img2)
    seat2.place(x=275, y=390)

    label4_2 = Label(root4, text="4B", background="green" if "4B" not in seat_choices.values() else "red", fg='white', font=('Calibri', 20, 'bold'))
    label4_2.place(x=275, y=544, width=154)

    seat3 = Label(root4, image=img2)
    seat3.place(x=475, y=390)

    label4_3 = Label(root4, text="4C", background="green" if "4C" not in seat_choices.values() else "red", fg='white', font=('Calibri', 20, 'bold'))
    label4_3.place(x=475, y=544, width=154)

    seat4 = Label(root4, image=img2)
    seat4.place(x=675, y=390)

    label4_4 = Label(root4, text="4D", background="green" if "4D" not in seat_choices.values() else "red", fg='white', font=('Calibri', 20, 'bold'))
    ...
    label6_1 = Label(root4, text="6A", background="green" if "6A" not in seat_choices.values() else "red", fg='white', font=('Calibri', 20, 'bold'))
    label6_1.place(x=875, y=314, width=154)

    seat2 = Label(root4, image=img3)
    seat2.place(x=1075, y=160)

    label6_2 = Label(root4, text="6B", background="green" if "6B" not in seat_choices.values() else "red", fg='white', font=('Calibri', 20, 'bold'))
    label6_2.place(x=1075, y=314, width=154)

    seat3 = Label(root4, image=img3)
    seat3.place(x=1275, y=160)

    label6_3 = Label(root4, text="6C", background="green" if "6C" not in seat_choices.values() else "red", fg='white', font=('Calibri', 20, 'bold'))
    ...
    label8_1 = Label(root4, text="8A", background="green" if "8A" not in seat_choices.values() else "red", fg='white', font=('Calibri', 20, 'bold'))
    label8_1.place(x=875, y=544, width=154)

    seat2 = Label(root4, image=img4)
    seat2.place(x=1075, y=390)

    label8_2 = Label(root4, text="8B", background="green" if "8B" not in seat_choices.values() else "red", fg='white', font=('Calibri', 20, 'bold'))
    label8_2.place(x=1075, y=544, width=154)

    seat3 = Label(root4, image=img4)
    seat3.place(x=1275, y=390)

    label8_3 = Label(root4, text="8C", background="green" if "8C" not in seat_choices.values() else "red", fg='white', font=('Calibri', 20, 'bold'))
        ...
        if seats_no:
            if 0 < seats_no<=2:
             if two_seats:
                ...
                messagebox.showinfo("NOTE","Two seated tables are Empty!")
                send_email_to_customer(customer_email)  # Add this line
                resetfield()
            elif 2 < seats_no <=4:
             if four_seats:
                s=four_seats.pop(0)
                ...
                root_success.destroy()
                messagebox.showinfo("NOTE","Four seated Tables are Empty!")
                send_email_to_customer(customer_email)
                resetfield()
            elif 4 < seats_no <= 6:
             if six_seats:
                s=six_seats.pop(0)
                ...
                root_success.destroy()
                messagebox.showinfo("NOTE","Six seated Tables are Empty!")
                send_email_to_customer(customer_email)
                resetfield()
            elif 6 < seats_no <=8:
             if eight_seats:
                ...
                root_success.destroy()
                messagebox.showinfo("NOTE","Eigth seated Tables are Empty!")
                send_email_to_customer(customer_email)
                resetfield()
            ...
            if s:
             if s not in seat_choices.values():
                seat_choices[label] = s  # STORE THE DATA FOR UPDATING PURPOSES I.E:COLOUR
