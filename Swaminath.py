...
def seatchooser():
    ...
    seats = CTkEntry(master=root4, placeholder_text="Enter the number of seats", fg_color=("light green"),
                     text_color="white", width=195, height=40, corner_radius=10, placeholder_text_color="white",
                     border_width=0, bg_color="#964B00", font=("times new roman", 17))
    ...
    """, fg_color="green", width=300, height=35, font=("New Times Roman", 15),
            ...
            # refresh button
            button = CTkButton(root, text="Refresh", fg_color="#008000", hover_color="#00cc66", corner_radius=20,
                               bg_color="brown", command=lambda: refresh(label2_1))
    ...
    # enter to book
    book = CTkButton(master=root4, text="Book", fg_color="blue", hover_color="blue", bg_color="brown",
                     corner_radius=20, command=book)
...
def managerview():
   ...
   # Manviewframe = Frame(root5, bg='black', width=450, height=900)
    ...
    Loginbutton = Button(root5,text='Back to Login Page',command=loginpageaction,font=("Copperplate Gothic Bold",20, "bold"),bd=0,cursor="hand2",
                    bg="green",fg="white",activebackground='green')
...
def customersystem():
    ...
    Submitbutton = Button(Cusloginframe,text='Submit',command=cusentry,font=("Copperplate Gothic Bold",20, "bold"),bd=0,cursor="hand2",
                    bg="green",fg="white",activebackground='green')
...
def mansignup():
    ...
    Createbutton = Button(Mansignupframe, text='Create Account', command=mandetails, font=("Copperplate Gothic Bold", 20, "bold"), bd=0,
...
def managersystem():
    ...
    Submitbutton = Button(Manloginframe, text='Submit', command=manentry, font=("Copperplate Gothic Bold", 20, "bold"), bd=0,
                          cursor="hand2",bg="green", fg="white", activebackground='green')
    Submitbutton.place(x=180, y=410)

    createacctbutton = Button(Manloginframe, text='New Manager? Create account', command=mansignup, font=("Copperplate Gothic Bold", 18, "bold"), bd=0,
                          cursor="hand2",bg="blue", fg="white", activebackground='blue')
...
def introscreen():
    ...
    Introtext = Label(Topframe,text='Welcome to Sri Swaminath Cafe New',font=('Copperplate Gothic Bold',24,'bold','italic')
                      ,bg='black',fg='white',activebackground='black')
    Introtext.place(x=120,y=10,width=750)
    Bottomtext = Label(Topframe,text='Experience the delicacies of South India at the right price',font=('Copperplate Gothic Bold',18,'bold','italic')
                      ,bg='black',fg='white',activebackground='black')
    ...
    Loginframetext = Label(Loginframe,text='LOGIN AS',font=('Rockwell',32,'bold'),bg='black',fg='white',activebackground='black')
    Loginframetext.place(x=80,y=30,width=250)

    customerbutton = Button(Loginframe,text='Customer',command=customerlogin,font=('Rockwell',24,'bold'),cursor='hand2',bd=0
                      ,bg='blue',fg='white',activebackground='blue')
    customerbutton.place(x=80,y=140,width=250)

    managerbutton = Button(Loginframe,text='Hotel Manager',command=managerlogin,font=('Rockwell',24,'bold'),cursor='hand2',bd=0
